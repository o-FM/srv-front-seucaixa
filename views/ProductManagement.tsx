  ...
  if (isFormOpen && editingProduct) {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-black flex flex-col animate-in fade-in duration-300">
        ...
        <SafeHeader
          title={products.find(p => p.id === editingProduct.id) ? 'Editar Produto' : 'Novo Produto'}
          onBack={() => {
            setIsFormOpen(false);
            setEditingProduct(null);
          }}
        ...
        {/* <header
          className="shrink-0 p-4 border-b border-zinc-900 bg-zinc-950/80 backdrop-blur-md z-10 flex items-center justify-between"
          style={{
                ...
                <div className="flex flex-wrap gap-2">
                  {CATEGORIES.map(cat => (
                    <button
                      ...
                      className={`px-4 py-2.5 rounded-full text-[10px] font-bold border transition-all ${editingProduct.category === cat
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3">
                    <div className={`px-3 py-1 rounded-full text-[9px] font-black uppercase border ${product.stock < 10 ? 'bg-red-500/10 text-red-500 border-red-500/20' :
